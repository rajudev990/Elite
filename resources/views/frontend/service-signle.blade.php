    ...
    <div class="container py-5">
        <div class="row g-5 align-items-center pb-5">
            ...
            <div class="section-title mb-5 wow fadeInUp" data-wow-delay="0.2s">
                <div class="sub-style">
                    <h4 class="sub-title px-3 mb-0">{{$section_title->tools_title}}</h4>
                </div>
                <p class="my-3">{{$section_title->tools_description}}</p>
            </div>
...
<section class="py-5">
    <div class="container">
        <div class="section-title mb-5 wow fadeInUp" data-wow-delay="0.2s">
            <div class="sub-style">
                <h4 class="sub-title px-3 mb-0">{{$section_title->ourprocess_title}}</h4>
            </div>
            <p class="my-3">{{$section_title->ourprocess_description}}</p>
        </div>
...
<div class="container-fluid about website-types-section  py-5">
    <div class="container py-5">
        <div class="row g-5 align-items-center pb-5">
            ...
            <div class="section-title mb-5 wow fadeInUp" data-wow-delay="0.2s">
                <div class="sub-style">
                    <h4 class="sub-title px-3 mb-0">{{$section_title->type_ofweb_title}}</h4>
                </div>
                <p class="my-3">{{$section_title->type_ofweb_description}}</p>
            </div>
...
<section id="features" class="features section price light-background py-5" style="background: #fff">
    ...
    <div class="section-title mb-5 wow fadeInUp" data-wow-delay="0.2s">
        <div class="sub-style">
            <h4 class="sub-title px-3 mb-0 display-3">{{$section_title->package_title}}</h4>
        </div>
        <p class="mt-3">{{$section_title->package_description}}</p>
    </div>
                    ...
                    <div class="col-md-4 col-lg-3 col-xl-3">
                        <div class="price-item shadow-lg rounded text-center">
                            <div class="price-top custom-wave-bg"
                                ...
                                <p class="fs-5 fw-bold text-uppercase mb-2">{{ $item->name }}</p>
                                <div class="price d-flex justify-content-center align-items-baseline">
                                    <strong class="fs-5 me-1">$</strong> {{ $item->price }} <span class="ms-1">{{ $item->vat }} VAT/{{ $item->duration }}</span>
                                </div>
                            </div>
                            <div class="featuresitem text-start pt-0">
                                <h4 class="text-center mb-0">{{ $item->speed }}</h4>
